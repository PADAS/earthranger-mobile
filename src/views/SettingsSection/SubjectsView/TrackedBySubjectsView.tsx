...
// Styles
import styles from './TrackedBySubjectsView.styles';

// Interfaces + Types
interface TrackedBySubjectsViewProps {
  navigation: NativeStackNavigationProp<RootStackParamList, 'TrackedBySubjectsView'>;
}

const TrackedBySubjectsView = ({ navigation }: TrackedBySubjectsViewProps) => {
  // Hooks
  ...
  const showSearchInput = () => {
    ...
    const route = routes.find((item: any) => item.name === 'TrackedBySubjectsView');
